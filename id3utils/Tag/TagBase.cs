...
using System.IO;
using ID3Utils.Frames;
using ID3Utils.Frames.Parsers;
using ID3Utils.Frames.Writers;
...
namespace ID3Utils
{
        ...
        : EventArgs
    {
        ...
        public NonFatalException Exception { get; private set; }
    ...
    public class TagBase
    {
        ...
        public List<Frames.Frame> Frames { get; private set; }
